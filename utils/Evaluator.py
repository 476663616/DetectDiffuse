# -*- coding:utf-8 -*-
###
# File: /home/xinyul/python_exercises/3D_diffusuionDet/metrics_util.py
# Project: /home/xinyul/python_exercises/3D_diffusuionDet
# Created Date: Saturday, November 11th 2023, 5:27:48 pm
# Author: Xinyu Li
# Email: 3120235098@bit.edu.cn
# Description: 涵盖了目前常用的，目标检测及分割所需的评价指标，待补充。
# -----
# Last Modified: 2023-11-12 16:49:25
...
def xywh2xyxy(bbox):
    '''
    Convert bbox (x, y, w, h), which reflects (top, left, wide, height), (y0, x0, y1, x1) that reflects
            (top, left, bottom, right)
    input: a list of bbox: [bbox1, bbox2, ..., bboxn]
    '''
    _bboxs = []
    for _bbox in bbox:
...
def xyx2xywh(bbox):
    '''
    The reverse process of xyxy2xywh.
    '''
    _bboxs = []
    for _bbox in bbox:
        _bboxs.append([_bbox[0], _bbox[1], _bbox[2] - _bbox[0] + 1, _bbox[3] - _bbox[1] + 1])
